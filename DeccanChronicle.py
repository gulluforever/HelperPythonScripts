        ...
        for a in links:
            try:
                if 'deccanchronicle.com' in a['href']:
                    ...
                    wai = WordAi('email@emailhere.com','passhere')
                    print(content)
...
wp = Client('http://googlenew.in/xmlrpc.php', 'admin', 'gdfdendfdfdidfdfus1dfd2dfdf3.')
pages20("http://www.deccanchronicle.com/technology/latest")
